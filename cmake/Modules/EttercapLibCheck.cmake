...
message(STATUS "HAVE_STRLCAT_FUNCTION: ${HAVE_STRLCAT_FUNCTION}")
message(STATUS "HAVE_STRLCPY_FUNCTION: ${HAVE_STRLCPY_FUNCTION}")

if(NOT HAVE_STRLCAT_FUNCTION OR NOT HAVE_STRLCPY_FUNCTION)
    check_library_exists(bsd strlcat "bsd/string.h" HAVE_STRLCAT)
message(STATUS "HAVE_STRLCAT: ${HAVE_STRLCAT}")
